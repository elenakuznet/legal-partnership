...
if (isset($action))
{
 ...
 // �������� ���������
       ...
       $querynew = "nazvanie='{$_POST["nazvanie"]}',kat='{$_POST["kat"]}',persona='{$_POST["persona"]}',opisanie1='{$_POST["opisanie1"]}',opisanie2='{$_POST["opisanie2"]}',opisanie3='{$_POST["opisanie3"]}',day='{$_POST["day"]}',mount='{$_POST["mount"]}',year='{$_POST["year"]}',vk='{$_POST["vk"]}',insta='{$_POST["insta"]}',title1='{$_POST["title1"]}',title2='{$_POST["title2"]}',title3='{$_POST["title3"]}'"; 
           
       $update =  /* fixed MMiC */ DB::Query("UPDATE spory SET $querynew WHERE id = '$id'",$link); 
...
echo '
					<div class="progressbar-heading grids-heading">
						<h2>	<a class="subnav-text" href="spory.php">'.$row["text10"].'</a>: изменение данных</h2>
					</div>
						';
...
<a href="edit_spory.php?id='.$row["id"].'&img1='.$row["img1"].'&action=delete" ></a>
</div></td>
