...
if (move_uploaded_file($_FILES['uimage']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE magazin SET img1='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage2']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE magazin SET img2='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage3']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE magazin SET img3='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage4']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE magazin SET img4='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage5']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE magazin SET img5='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage6']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE magazin SET img6='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage7']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE magazin SET img7='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage8']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE magazin SET img8='$newfilename'",$link);   
