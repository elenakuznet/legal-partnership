...
if (move_uploaded_file($_FILES['uimage']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img1='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage2']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img2='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage3']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img3='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage4']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img4='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage5']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img5='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage6']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img6='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage7']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img7='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage8']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img8='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage9']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img9='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage10']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET img10='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage11']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage12']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel2='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage13']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel3='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage14']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel4='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage15']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel5='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage16']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel6='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage17']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel7='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage18']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel8='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage19']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel9='$newfilename' WHERE id = '$id'",$link);   
...
if (move_uploaded_file($_FILES['uimage20']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE novosti SET imgtel10='$newfilename' WHERE id = '$id'",$link);   
