...
if (move_uploaded_file($_FILES['uimage']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE site SET img1='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage2']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE site SET img2='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage3']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE site SET img3='$newfilename'",$link);   
...
if (move_uploaded_file($_FILES['uimage4']['tmp_name'], $uploadfile))
{
  ...
  $update =  /* fixed MMiC */ DB::Query("UPDATE site SET img4='$newfilename'",$link);   
