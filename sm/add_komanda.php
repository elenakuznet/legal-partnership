...
if ($_SESSION['auth_admin'] == "yes_auth")
{
 ...
 if ($_SESSION['add_tovar'] == '1')
   {
      ...
      {
       	$result =  /* fixed MMiC */ DB::Query("SELECT * FROM komanda",$link);
 ...
 // проверка чекбоксов
       ...
       }else
       {
              		 ...
              		 /* fixed MMiC */ DB::Query("INSERT INTO komanda(name,napr,opisanie,title1,title2,title3,text1,text2,text3)
						VALUES(						
                            '".$_POST["name"]."',
							'".$_POST["napr"]."',
							'".$_POST["opisanie"]."',
...
echo '
					<div class="progressbar-heading grids-heading">
						<h2>	<a class="subnav-text" href="komanda.php">'.$row["text7"].'</a>: добавление</h2>
					</div>
						';
...
<form enctype="multipart/form-data" method="post">
								...
								<table class="table">
												...
												<td>
												<input type="text" class="alert alert-success" role="alert" name="name"/></td>
									...
									<table class="table2">
												...
												<td>
												<textarea class="alert alert-success" role="alert" name="napr"></textarea>
												</td>
									...
									<table class="table2">
												...
												<td>
												<textarea class="alert alert-success" role="alert" name="opisanie"></textarea>
												</td>
