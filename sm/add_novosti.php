...
if ($_SESSION['auth_admin'] == "yes_auth")
{
 ...
 if ($_SESSION['add_tovar'] == '1')
   {
      ...
      {
       	$result =  /* fixed MMiC */ DB::Query("SELECT * FROM novosti",$link);
 ...
 // проверка чекбоксов
       ...
       }else
       {
              		 ...
              		 /* fixed MMiC */ DB::Query("INSERT INTO novosti(nazvanie,kat,persona,opisanie1,opisanie2,opisanie3,day,mount,year,vk,insta,youtube)
						VALUES(						
                            '".$_POST["nazvanie"]."',
							'".$_POST["kat"]."',
							'".$_POST["persona"]."',
...
echo '
					<div class="progressbar-heading grids-heading">
						<h2>	<a class="subnav-text" href="novosti.php">'.$row["text8"].'</a>: добавление</h2>
					</div>
						';
								...
								<table class="table">
									...
									<table class="table">
										...
										<td><h4 id="h1.-bootstrap-heading">Youtube<a class="anchorjs-link" href="#h1.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h4></td>
												<td>
												<textarea class="alert alert-success" role="alert" name="youtube"></textarea>
												</td>
