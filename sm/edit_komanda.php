...
if (isset($action))
{
       ...
       if ($_SESSION['edit_tovar'] == '1')
   {
    ...
    // �������� �����
      ...
      {        
      include("actions/upload-image-komanda.php");
      unset($_POST["uimage"]);           
      } 
 ...
 // �������� ���������
       ...
       $querynew = "name='{$_POST["name"]}',napr='{$_POST["napr"]}',opisanie='{$_POST["opisanie"]}',title1='{$_POST["title1"]}',title2='{$_POST["title2"]}',title3='{$_POST["title3"]}',text1='{$_POST["text1"]}',text2='{$_POST["text2"]}',text3='{$_POST["text3"]}'"; 
           
       $update =  /* fixed MMiC */ DB::Query("UPDATE komanda SET $querynew WHERE id = '$id'",$link); 
...
echo '
					<div class="progressbar-heading grids-heading">
						<h2>	<a class="subnav-text" href="komanda.php">'.$row["text7"].'</a>: изменение данных</h2>
					</div>
						';
...
?> 
			...
			<?php
	$result =  /* fixed MMiC */ DB::Query("SELECT * FROM komanda WHERE id='$id'",$link);
...
<form enctype="multipart/form-data" method="post">
									...
									<table class="table">
												...
												<td><h4 id="h1.-bootstrap-heading">Имя<a class="anchorjs-link" href="#h1.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h4></td>
												<td>
												<input type="text" class="alert alert-success" role="alert" name="name" value="'.$row["name"].'" /></td>
										...
										<table class="table2">
												...
												<td><h4 id="h1.-bootstrap-heading">Направления специализации<a class="anchorjs-link" href="#h1.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h4></td>
												<td>
												<textarea class="alert alert-success" role="alert" name="napr">'.$row["napr"].'</textarea>
												</td>
									...
									<table class="table2">
												...
												<td>
												<textarea class="alert alert-success" role="alert" name="opisanie">'.$row["opisanie"].'</textarea>
												</td>
...
echo '
									...
									<table class="table3">
												...
												<td><h4 id="h1.-bootstrap-heading">Изображение<a class="anchorjs-link" href="#h1.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h4>
												<div id="baseimg">
<img src="'.$img_path.'" width="'.$width.'" height="'.$height.'" />
<a href="edit_komanda.php?id='.$row["id"].'&img1='.$row["img1"].'&action=delete" ></a>
</div></td>
